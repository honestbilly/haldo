...
<body style="background:#F2F2F7">
  <header style="position:fixed;top:0;left:0;right:0;z-index:50;background:rgba(255,255,255,0.85);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);display:flex;justify-content:center;align-items:center;height:44px">
    <span style="font-family:'Inter',sans-serif;font-weight:600;font-size:1.0625rem;color:#1a1c1e;letter-spacing:-0.01em">Weather</span>
  </header>
  <main style="max-width:480px;margin:0 auto;padding:60px 16px 120px;text-align:center">
...
<body style="background:#F2F2F7">
  <header style="position:fixed;top:0;left:0;right:0;z-index:50;background:rgba(255,255,255,0.85);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);display:flex;justify-content:space-between;align-items:center;padding:0 16px;height:44px">
    ...
    <span style="font-family:'Inter',sans-serif;font-weight:600;font-size:1.0625rem;color:#1a1c1e;letter-spacing:-0.01em">Weather & Tides</span>
  ...
  <main style="max-width:480px;margin:0 auto;padding:60px 16px 120px">
    ...
    <!-- Current Conditions — Stitch card pattern -->
    <section style="background:white;border-radius:12px;padding:24px;box-shadow:0 1px 4px rgba(0,0,0,0.04);border:1px solid rgba(0,0,0,0.04);margin-bottom:16px;position:relative;overflow:hidden">
      <div style="position:absolute;top:-10px;right:-10px;width:100px;height:100px;opacity:0.06;pointer-events:none">
        <span class="material-symbols-outlined" style="font-size:100px;color:#FF9500;font-variation-settings:'FILL' 1">wb_sunny</span>
      </div>
    ...
    <section style="background:white;border-radius:12px;padding:20px;box-shadow:0 1px 4px rgba(0,0,0,0.04);border:1px solid rgba(0,0,0,0.04);margin-bottom:16px">
      <h3 style="font-size:0.75rem;font-weight:700;letter-spacing:0.1em;color:#8E8E93;text-transform:uppercase;margin-bottom:8px;padding:0 16px">Tides — Key West</h3>
      ${tideRows}
    </section>` : ''}

    <!-- Hourly Forecast -->
    <section style="background:white;border-radius:12px;padding:20px;box-shadow:0 1px 4px rgba(0,0,0,0.04);border:1px solid rgba(0,0,0,0.04);margin-bottom:16px">
      <h3 style="font-size:0.75rem;font-weight:700;letter-spacing:0.1em;color:#8E8E93;text-transform:uppercase;margin-bottom:8px;padding:0 16px">Hourly Forecast</h3>
